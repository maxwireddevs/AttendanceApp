...
public class AttendanceHandlerRecyclerViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    private final TextView attendancestudentduration;
    ...
    public AttendanceHandlerRecyclerViewHolder(Context context,View itemView){
        ...
        this.attendancestudentduration=(TextView)itemView.findViewById(R.id.student_duration_attendancerecyclerview_item);
    ...
    public void bindAttendance(AttendanceStorage attendanceStorage){
        ...
        String studentdurationadjust="Duration: "+attendanceStorage.getDuration();
        ...
        this.attendancestudentduration.setText(studentdurationadjust);
    }
